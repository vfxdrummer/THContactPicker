...
#define kBubbleColor                      [UIColor clearColor]
#define kBubbleColorSelected              [UIColor clearColor]
...
- (void)setupView {
  ...
  switch (self.position) {
    case (PositionSingle):
    case (PositionSecondToLast):
      self.label.text = self.name;
      break;
    case (PositionNotLast):
